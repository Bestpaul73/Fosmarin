...
function ConsortiumGlance({ id }) {
  ...
  const content = translations.about.consortiumGlance;
      ...
      <div className='consortium-glance-inner'>
        <Reveal as='header' className='consortium-glance-header'>
          <div className='consortium-glance-heading'>
            <p className='consortium-glance-eyebrow'>{content.eyebrow}</p>

            <h2 id='consortium-glance-title'>{content.title}</h2>

            <p className='consortium-glance-intro'>{content.intro}</p>
          </div>

          <div className='consortium-glance-stats' aria-label={content.statsLabel}>
            <div>
              <strong>13</strong>
        ...
        <div className='consortium-glance-content'>
          <Reveal
            as='a'
            className='consortium-glance-coordinator'
            href={coordinator.website}
            target='_blank'
            rel='noopener noreferrer'
            aria-label={`${coordinator.name} — ${coordinator.legalName}`}
          >
            <span className='consortium-glance-label'>{content.coordinator}</span>
            ...
            <p>{content.coordinatorDescription}</p>

            <span className='consortium-glance-country'>{content.coordinatorCountry}</span>
          </Reveal>
        ...
        <Reveal className='consortium-glance-footer'>
          ...
          <Link className='consortium-glance-link' to={getLocalizedPath('/consortium#partners')}>
            {content.linkLabel}
